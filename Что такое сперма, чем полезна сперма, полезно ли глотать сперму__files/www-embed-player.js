...
for(var e=2;e<c.length;e++){var f=c[e];!Ca(f)||B(f)&&0<f.nodeType?d(f):G(gc(f)?Ra(f):f,d)}}
...
function b(n){for(var v=g,q=0;64>q;q+=4)v[q/4]=n[q]<<24|n[q+1]<<16|n[q+2]<<8|n[q+3];for(q=16;80>q;q++)n=v[q-3]^v[q-8]^v[q-14]^v[q-16],v[q]=(n<<1|n>>>31)&4294967295;n=e[0];var y=e[1],U=e[2],la=e[3],Cc=e[4];for(q=0;80>q;q++){if(40>q)if(20>q){var Ja=la^y&(U^la);var Fb=1518500249}else Ja=y^U^la,Fb=1859775393;else 60>q?(Ja=y&U|la&(y|U),Fb=2400959708):(Ja=y^U^la,Fb=3395469782);Ja=((n<<5|n>>>27)&4294967295)+Ja+Cc+Fb+v[q]&4294967295;Cc=la;la=U;U=(y<<30|y>>>2)&4294967295;y=n;n=Ja}e[0]=e[0]+n&4294967295;e[1]=
e[1]+y&4294967295;e[2]=e[2]+U&4294967295;e[3]=e[3]+la&4294967295;e[4]=e[4]+Cc&4294967295}
...
;function Dc(a,b){this.h=a;this.i=b;this.g=0;this.f=null}
Dc.prototype.get=function(){if(0<this.g){this.g--;var a=this.f;this.f=a.next;a.next=null}else a=this.h();return a};
...
;function Rc(){this.g=-1}
;function Sc(){this.g=64;this.f=[];this.l=[];this.A=[];this.i=[];this.i[0]=128;for(var a=1;a<this.g;++a)this.i[a]=0;this.j=this.h=0;this.reset()}
E(Sc,Rc);Sc.prototype.reset=function(){this.f[0]=1732584193;this.f[1]=4023233417;this.f[2]=2562383102;this.f[3]=271733878;this.f[4]=3285377520;this.j=this.h=0};
function Tc(a,b,c){c||(c=0);var d=a.A;if("string"===typeof b)for(var e=0;16>e;e++)d[e]=b.charCodeAt(c)<<24|b.charCodeAt(c+1)<<16|b.charCodeAt(c+2)<<8|b.charCodeAt(c+3),c+=4;else for(e=0;16>e;e++)d[e]=b[c]<<24|b[c+1]<<16|b[c+2]<<8|b[c+3],c+=4;for(e=16;80>e;e++){var f=d[e-3]^d[e-8]^d[e-14]^d[e-16];d[e]=(f<<1|f>>>31)&4294967295}b=a.f[0];c=a.f[1];var g=a.f[2],h=a.f[3],k=a.f[4];for(e=0;80>e;e++){if(40>e)if(20>e){f=h^c&(g^h);var l=1518500249}else f=c^g^h,l=1859775393;else 60>e?(f=c&g|h&(c|g),l=2400959708):
(f=c^g^h,l=3395469782);f=(b<<5|b>>>27)+f+k+l+d[e]&4294967295;k=h;h=g;g=(c<<30|c>>>2)&4294967295;c=b;b=f}a.f[0]=a.f[0]+b&4294967295;a.f[1]=a.f[1]+c&4294967295;a.f[2]=a.f[2]+g&4294967295;a.f[3]=a.f[3]+h&4294967295;a.f[4]=a.f[4]+k&4294967295}
Sc.prototype.update=function(a,b){if(null!=a){void 0===b&&(b=a.length);for(var c=b-this.g,d=0,e=this.l,f=this.h;d<b;){if(0==f)for(;d<=c;)Tc(this,a,d),d+=this.g;if("string"===typeof a)for(;d<b;){if(e[f]=a.charCodeAt(d),++f,++d,f==this.g){Tc(this,e);f=0;break}}else for(;d<b;)if(e[f]=a[d],++f,++d,f==this.g){Tc(this,e);f=0;break}}this.h=f;this.j+=b}};
Sc.prototype.digest=function(){var a=[],b=8*this.j;56>this.h?this.update(this.i,56-this.h):this.update(this.i,this.g-(this.h-56));for(var c=this.g-1;56<=c;c--)this.l[c]=b&255,b/=256;Tc(this,this.l);for(c=b=0;5>c;c++)for(var d=24;0<=d;d-=8)a[b]=this.f[c]>>d&255,++b;return a};function L(){this.g=this.g;this.A=this.A}
...
function Wc(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];Ca(d)?Wc.apply(null,d):Vc(d)}}
...
function Zc(a,b){if(a.classList)var c=a.classList.contains(b);else c=a.classList?a.classList:Xc(a).match(/\S+/g)||[],c=0<=La(c,b);return c}
function $c(){var a=document.body;a.classList?a.classList.remove("inverted-hdpi"):Zc(a,"inverted-hdpi")&&Yc(a,Ma(a.classList?a.classList:Xc(a).match(/\S+/g)||[],function(b){return"inverted-hdpi"!=b}).join(" "))}
;var ad="StopIteration"in w?w.StopIteration:{message:"StopIteration",stack:""};function bd(){}
bd.prototype.next=function(){throw ad;};
bd.prototype.D=function(){return this};
function cd(a){if(a instanceof bd)return a;if("function"==typeof a.D)return a.D(!1);if(Ca(a)){var b=0,c=new bd;c.next=function(){for(;;){if(b>=a.length)throw ad;if(b in a)return a[b++];b++}};
return c}throw Error("Not implemented");}
function dd(a,b){if(Ca(a))try{G(a,b,void 0)}catch(c){if(c!==ad)throw c;}else{a=cd(a);try{for(;;)b.call(void 0,a.next(),void 0,a)}catch(c){if(c!==ad)throw c;}}}
function ed(a){if(Ca(a))return Ra(a);a=cd(a);var b=[];dd(a,function(c){b.push(c)});
return b}
;function fd(a,b){this.h={};this.f=[];this.F=this.g=0;var c=arguments.length;if(1<c){if(c%2)throw Error("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else if(a)if(a instanceof fd)for(c=gd(a),d=0;d<c.length;d++)this.set(c[d],a.get(c[d]));else for(d in a)this.set(d,a[d])}
function gd(a){hd(a);return a.f.concat()}
m=fd.prototype;m.equals=function(a,b){if(this===a)return!0;if(this.g!=a.g)return!1;var c=b||id;hd(this);for(var d,e=0;d=this.f[e];e++)if(!c(this.get(d),a.get(d)))return!1;return!0};
function id(a,b){return a===b}
m.isEmpty=function(){return 0==this.g};
m.clear=function(){this.h={};this.F=this.g=this.f.length=0};
m.remove=function(a){return Object.prototype.hasOwnProperty.call(this.h,a)?(delete this.h[a],this.g--,this.F++,this.f.length>2*this.g&&hd(this),!0):!1};
...
m.forEach=function(a,b){for(var c=gd(this),d=0;d<c.length;d++){var e=c[d],f=this.get(e);a.call(b,f,e,this)}};
m.clone=function(){return new fd(this)};
m.D=function(a){hd(this);var b=0,c=this.F,d=this,e=new bd;e.next=function(){if(c!=d.F)throw Error("The map has changed since the iterator was created");if(b>=d.f.length)throw ad;var f=d.f[b++];return a?f:d.h[f]};
return e};function jd(a){var b=[];kd(new ld,a,b);return b.join("")}
function ld(){}
function kd(a,b,c){if(null==b)c.push("null");else{if("object"==typeof b){if(Ba(b)){var d=b;b=d.length;c.push("[");for(var e="",f=0;f<b;f++)c.push(e),kd(a,d[f],c),e=",";c.push("]");return}if(b instanceof String||b instanceof Number||b instanceof Boolean)b=b.valueOf();else{c.push("{");e="";for(d in b)Object.prototype.hasOwnProperty.call(b,d)&&(f=b[d],"function"!=typeof f&&(c.push(e),md(d,c),c.push(":"),kd(a,f,c),e=","));c.push("}");return}}switch(typeof b){case "string":md(b,c);break;case "number":c.push(isFinite(b)&&
...
;function M(a){this.f=0;this.A=void 0;this.i=this.g=this.h=null;this.j=this.l=!1;if(a!=ya)try{var b=this;a.call(void 0,function(c){qd(b,2,c)},function(c){qd(b,3,c)})}catch(c){qd(this,3,c)}}
...
var sd=new Dc(function(){return new rd},function(a){a.reset()});
function td(a,b,c){var d=sd.get();d.g=a;d.onRejected=b;d.context=c;return d}
function ud(a){return new M(function(b,c){c(a)})}
M.prototype.then=function(a,b,c){return vd(this,A(a)?a:null,A(b)?b:null,c)};
M.prototype.$goog_Thenable=!0;function wd(a,b){return vd(a,null,b,void 0)}
M.prototype.cancel=function(a){if(0==this.f){var b=new xd(a);Lc(function(){yd(this,b)},this)}};
function yd(a,b){if(0==a.f)if(a.h){var c=a.h;if(c.g){for(var d=0,e=null,f=null,g=c.g;g&&(g.h||(d++,g.f==a&&(e=g),!(e&&1<d)));g=g.next)e||(f=g);e&&(0==c.f&&1==d?yd(c,b):(f?(d=f,d.next==c.i&&(c.i=d),d.next=d.next.next):zd(c),Ad(c,e,3,b)))}a.h=null}else qd(a,3,b)}
function Bd(a,b){a.g||2!=a.f&&3!=a.f||Cd(a);a.i?a.i.next=b:a.g=b;a.i=b}
function vd(a,b,c,d){var e=td(null,null,null);e.f=new M(function(f,g){e.g=b?function(h){try{var k=b.call(d,h);f(k)}catch(l){g(l)}}:f;
e.onRejected=c?function(h){try{var k=c.call(d,h);void 0===k&&h instanceof xd?g(h):f(k)}catch(l){g(l)}}:g});
e.f.h=a;Bd(a,e);return e.f}
M.prototype.w=function(a){this.f=0;qd(this,2,a)};
M.prototype.B=function(a){this.f=0;qd(this,3,a)};
function qd(a,b,c){if(0==a.f){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.f=1;a:{var d=c,e=a.w,f=a.B;if(d instanceof M){Bd(d,td(e||ya,f||null,a));var g=!0}else if(pd(d))d.then(e,f,a),g=!0;else{if(B(d))try{var h=d.then;if(A(h)){Dd(d,h,e,f,a);g=!0;break a}}catch(k){f.call(a,k);g=!0;break a}g=!1}}g||(a.A=c,a.f=b,a.h=null,Cd(a),3!=b||c instanceof xd||Ed(a,c))}}
function Dd(a,b,c,d,e){function f(k){h||(h=!0,d.call(e,k))}
function g(k){h||(h=!0,c.call(e,k))}
var h=!1;try{b.call(a,g,f)}catch(k){f(k)}}
function Cd(a){a.l||(a.l=!0,Lc(a.o,a))}
function zd(a){var b=null;a.g&&(b=a.g,a.g=b.next,b.next=null);a.g||(a.i=null);return b}
M.prototype.o=function(){for(var a;a=zd(this);)Ad(this,a,this.f,this.A);this.l=!1};
function Ad(a,b,c,d){if(3==c&&b.onRejected&&!b.h)for(;a&&a.j;a=a.h)a.j=!1;if(b.f)b.f.h=null,Fd(b,c,d);else try{b.h?b.g.call(b.context):Fd(b,c,d)}catch(e){Gd.call(null,e)}Ec(sd,b)}
function Fd(a,b,c){2==b?a.g.call(a.context,c):a.onRejected&&a.onRejected.call(a.context,c)}
function Ed(a,b){a.j=!0;Lc(function(){a.j&&Gd.call(null,b)})}
var Gd=Fc;function xd(a){F.call(this,a)}
E(xd,F);xd.prototype.name="cancel";function N(a){L.call(this);this.l=1;this.i=[];this.j=0;this.f=[];this.h={};this.o=!!a}
...
function Hd(a,b,c,d){if(b=a.h[b]){var e=a.f;(b=Pa(b,function(f){return e[f+1]==c&&e[f+2]==d}))&&a.N(b)}}
...
m.M=function(a,b){var c=this.h[a];if(c){for(var d=Array(arguments.length-1),e=1,f=arguments.length;e<f;e++)d[e-1]=arguments[e];if(this.o)for(e=0;e<c.length;e++){var g=c[e];Id(this.f[g+1],this.f[g+2],d)}else{this.j++;try{for(e=0,f=c.length;e<f;e++)g=c[e],this.f[g+1].apply(this.f[g+2],d)}finally{if(this.j--,0<this.i.length&&0==this.j)for(;c=this.i.pop();)this.N(c)}}return 0!=e}return!1};
function Id(a,b,c){Lc(function(){a.apply(b,c)})}
m.clear=function(a){if(a){var b=this.h[a];b&&(G(b,this.N,this),delete this.h[a])}else this.f.length=0,this.h={}};
m.m=function(){N.L.m.call(this);this.clear();this.i.length=0};function Jd(a){this.f=a}
Jd.prototype.set=function(a,b){void 0===b?this.f.remove(a):this.f.set(a,jd(b))};
Jd.prototype.get=function(a){try{var b=this.f.get(a)}catch(c){return}if(null!==b)try{return JSON.parse(b)}catch(c){throw"Storage: Invalid value was encountered";}};
Jd.prototype.remove=function(a){this.f.remove(a)};function Kd(a){this.f=a}
E(Kd,Jd);function Ld(a){this.data=a}
function Md(a){return void 0===a||a instanceof Ld?a:new Ld(a)}
Kd.prototype.set=function(a,b){Kd.L.set.call(this,a,Md(b))};
Kd.prototype.g=function(a){a=Kd.L.get.call(this,a);if(void 0===a||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
Kd.prototype.get=function(a){if(a=this.g(a)){if(a=a.data,void 0===a)throw"Storage: Invalid value was encountered";}else a=void 0;return a};function Nd(a){this.f=a}
E(Nd,Kd);Nd.prototype.set=function(a,b,c){if(b=Md(b)){if(c){if(c<D()){Nd.prototype.remove.call(this,a);return}b.expiration=c}b.creation=D()}Nd.L.set.call(this,a,b)};
Nd.prototype.g=function(a){var b=Nd.L.g.call(this,a);if(b){var c=b.creation,d=b.expiration;if(d&&d<D()||c&&c>D())Nd.prototype.remove.call(this,a);else return b}};function Od(){}
;function Pd(){}
E(Pd,Od);Pd.prototype.clear=function(){var a=ed(this.D(!0)),b=this;G(a,function(c){b.remove(c)})};function Qd(a){this.f=a}
E(Qd,Pd);m=Qd.prototype;m.isAvailable=function(){if(!this.f)return!1;try{return this.f.setItem("__sak","1"),this.f.removeItem("__sak"),!0}catch(a){return!1}};
...
m.D=function(a){var b=0,c=this.f,d=new bd;d.next=function(){if(b>=c.length)throw ad;var e=c.key(b++);if(a)return e;e=c.getItem(e);if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
return d};
m.clear=function(){this.f.clear()};
m.key=function(a){return this.f.key(a)};function Rd(){var a=null;try{a=window.localStorage||null}catch(b){}this.f=a}
E(Rd,Qd);function Sd(a,b){this.g=a;this.f=null;if(Ob&&!(9<=Number(Pb))){Td||(Td=new fd);this.f=Td.get(a);this.f||(b?this.f=document.getElementById(b):(this.f=document.createElement("userdata"),this.f.addBehavior("#default#userData"),document.body.appendChild(this.f)),Td.set(a,this.f));try{this.f.load(this.g)}catch(c){this.f=null}}}
E(Sd,Pd);var Ud={".":".2E","!":".21","~":".7E","*":".2A","'":".27","(":".28",")":".29","%":"."},Td=null;function Vd(a){return"_"+encodeURIComponent(a).replace(/[.!~*'()%]/g,function(b){return Ud[b]})}
m=Sd.prototype;m.isAvailable=function(){return!!this.f};
m.set=function(a,b){this.f.setAttribute(Vd(a),b);Wd(this)};
m.get=function(a){a=this.f.getAttribute(Vd(a));if("string"!==typeof a&&null!==a)throw"Storage mechanism: Invalid value was encountered";return a};
m.remove=function(a){this.f.removeAttribute(Vd(a));Wd(this)};
m.D=function(a){var b=0,c=this.f.XMLDocument.documentElement.attributes,d=new bd;d.next=function(){if(b>=c.length)throw ad;var e=c[b++];if(a)return decodeURIComponent(e.nodeName.replace(/\./g,"%")).substr(1);e=e.nodeValue;if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
return d};
m.clear=function(){for(var a=this.f.XMLDocument.documentElement,b=a.attributes.length;0<b;b--)a.removeAttribute(a.attributes[b-1].nodeName);Wd(this)};
function Wd(a){try{a.f.save(a.g)}catch(b){throw"Storage mechanism: Quota exceeded";}}
;function Xd(a,b){this.g=a;this.f=b+"::"}
E(Xd,Pd);Xd.prototype.set=function(a,b){this.g.set(this.f+a,b)};
Xd.prototype.get=function(a){return this.g.get(this.f+a)};
Xd.prototype.remove=function(a){this.g.remove(this.f+a)};
Xd.prototype.D=function(a){var b=this.g.D(!0),c=this,d=new bd;d.next=function(){for(var e=b.next();e.substr(0,c.f.length)!=c.f;)e=b.next();return a?e.substr(c.f.length):c.g.get(e)};
return d};function Yd(){this.g=[];this.f=-1}
...
function Zd(a){-1==a.f&&(a.f=Oa(a.g,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.f}
;function $d(a,b){1<b.length?a[b[0]]=b[1]:1===b.length&&Object.assign(a,b[0])}
...
return oe(a,f||{},!1)}
function Ce(a,b){var c=P("CORS_HEADER_WHITELIST")||{},d=J(K(3,a));return d?(c=c[d])?0<=La(c,b):!1:!0}
...
;var eg=Math.pow(2,16)-1,fg=null,gg=0,hg={log_event:"events",log_interaction:"interactions"},ig=Object.create(null);ig.log_event="GENERIC_EVENT_LOGGING";ig.log_interaction="INTERACTION_LOGGING";var jg=new Set(["log_event"]),kg={},lg=0,mg=0,ng=0,W=z("ytLoggingTransportLogPayloadsQueue_")||{};x("ytLoggingTransportLogPayloadsQueue_",W,void 0);var og=z("ytLoggingTransportTokensToCttTargetIds_")||{};x("ytLoggingTransportTokensToCttTargetIds_",og,void 0);var pg=z("ytLoggingTransportDispatchedStats_")||{};
x("ytLoggingTransportDispatchedStats_",pg,void 0);x("ytytLoggingTransportCapturedTime_",z("ytLoggingTransportCapturedTime_")||{},void 0);function qg(){S(lg);S(mg);mg=0;if(!Ya(W)){for(var a in W){var b=kg[a];b&&b.isReady()&&(rg(a,b),delete W[a])}Ya(W)||sg()}}
function sg(){Q("web_gel_timeout_cap")&&!mg&&(mg=R(qg,6E4));S(lg);lg=R(qg,P("LOGGING_BATCH_TIMEOUT",ue("web_gel_debounce_ms",1E4)))}
function tg(a,b){b=void 0===b?"":b;W[a]=W[a]||{};W[a][b]=W[a][b]||[];return W[a][b]}
function rg(a,b){var c=hg[a],d=pg[a]||{};pg[a]=d;var e=Math.round(T());for(n in W[a]){var f=bb,g=b.f||ug();g={client:{hl:g.Fa,gl:g.Ea,clientName:g.Da,clientVersion:g.innertubeContextClientVersion,configInfo:g.Ca}};var h=window.devicePixelRatio;h&&1!=h&&(g.client.screenDensityFloat=String(h));h=P("EXPERIMENTS_TOKEN","");""!==h&&(g.client.experimentsToken=h);var k=h=void 0,l=[],p=P("EXPERIMENTS_FORCED_FLAGS",{});for(k in p)l.push({key:k,value:String(p[k])});k=P("EXPERIMENT_FLAGS",{});for(h in k)h.startsWith("force_")&&
void 0===p[h]&&l.push({key:h,value:String(k[h])});h=l;0<h.length&&(g.request={internalExperimentFlags:h});P("DELEGATED_SESSION_ID")&&!Q("pageid_as_header_web")&&(g.user={onBehalfOfUser:P("DELEGATED_SESSION_ID")});f=f({context:g});f[c]=tg(a,n);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=og[n])a:{l=n;if(g.videoId)h="VIDEO";else if(g.playlistId)h="PLAYLIST";else break a;f.credentialTransferTokenTargetId=g;f.context=f.context||{};f.context.user=f.context.user||
{};f.context.user.credentialTransferTokens=[{token:l,scope:h}]}delete og[n];f.requestTimeMs=e;Q("unsplit_gel_payloads_in_logs")&&(f.unsplitGelPayloadsInLogs=!0);if(g=P("EVENT_ID",void 0))h=(P("BATCH_CLIENT_COUNTER",void 0)||0)+1,h>eg&&(h=1),O("BATCH_CLIENT_COUNTER",h),g={serializedEventId:g,clientCounter:h},f.serializedClientEventId=g,fg&&gg&&Q("log_gel_rtt_web")&&(f.previousBatchInfo={serializedClientEventId:fg,roundtripMs:gg}),fg=g,gg=0;vg(b,a,f,{retry:jg.has(a),onSuccess:C(wg,this,T())})}if(d.previousDispatchMs){c=
...
function wg(a){gg=Math.round(T()-a)}
;var xg=z("ytLoggingGelSequenceIdObj_")||{};x("ytLoggingGelSequenceIdObj_",xg,void 0);
function yg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||T());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:dg())};Q("log_sequence_info_on_gel_web")&&d.P&&(a=e.context,b=d.P,xg[b]=b in xg?xg[b]+1:0,a.sequence={index:xg[b],groupKey:b},d.pb&&delete xg[d.P]);(d=d.ca)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),og[d.token]=a,d=tg("log_event",d.token)):d=tg("log_event");d.push(e);c&&(kg.log_event=new c);c=ue("web_logging_max_batch")||
100;e=T();d.length>=c?qg():10<=e-ng&&(sg(),ng=e)}
...
var Bg=1;function Cg(a,b){this.version=a;this.args=b}
;function Dg(a,b){this.topic=a;this.f=b}
Dg.prototype.toString=function(){return this.topic};var Eg=z("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.N;N.prototype.publish=N.prototype.M;N.prototype.clear=N.prototype.clear;x("ytPubsub2Pubsub2Instance",Eg,void 0);var Fg=z("ytPubsub2Pubsub2SubscribedKeys")||{};x("ytPubsub2Pubsub2SubscribedKeys",Fg,void 0);var Gg=z("ytPubsub2Pubsub2TopicToKeys")||{};x("ytPubsub2Pubsub2TopicToKeys",Gg,void 0);var Hg=z("ytPubsub2Pubsub2IsAsync")||{};x("ytPubsub2Pubsub2IsAsync",Hg,void 0);
x("ytPubsub2Pubsub2SkipSubKey",null,void 0);function Ig(a,b){var c=Jg();c&&c.publish.call(c,a.toString(),a,b)}
function Kg(a){var b=Lg,c=Jg();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=z("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(Fg[d])try{if(f&&b instanceof Dg&&b!=e)try{var h=b.f,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!h.F){var l=new h;h.F=l.version}var p=h.F}catch(n){}if(!p||k.version!=p)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(h,
Ra(k.args))}catch(n){throw n.message="yt.pubsub2.Data.deserialize(): "+n.message,n;}}catch(n){throw n.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+n.message,n;}a.call(window,f)}catch(n){je(n)}},Hg[b.toString()]?z("yt.scheduler.instance")?yf(g):R(g,0):g())});
Fg[d]=!0;Gg[b.toString()]||(Gg[b.toString()]=[]);Gg[b.toString()].push(d);return d}
function Mg(){var a=Ng,b=Kg(function(c){a.apply(void 0,arguments);Og(b)});
return b}
function Og(a){var b=Jg();b&&("number"===typeof a&&(a=[a]),G(a,function(c){b.unsubscribeByKey(c);delete Fg[c]}))}
function Jg(){return z("ytPubsub2Pubsub2Instance")}
;function Pg(a){Cg.call(this,1,arguments);this.csn=a}
t(Pg,Cg);var Lg=new Dg("screen-created",Pg),Qg=[],Rg=0;function Sg(a,b,c){var d=Tg;b={csn:a,parentVe:Ag(b),childVes:Na(c,function(f){return Ag(f)})};
c=r(c);for(var e=c.next();!e.done;e=c.next())e=Ag(e.value),(Ya(e)||!e.trackingParams&&!e.veType)&&Xe(Error("Child VE logged with no data"),"WARNING");c={ca:void 0,P:a};"UNDEFINED_CSN"==a?Ug("visualElementAttached",b,c):yg("visualElementAttached",b,d,c)}
function Ug(a,b,c){Qg.push({Ma:a,payload:b,options:c});Rg||(Rg=Mg())}
function Ng(a){if(Qg){for(var b=r(Qg),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,yg(c.Ma,c.payload,null,c.options));Qg.length=0}Rg=0}
;function Vg(){return"INNERTUBE_API_KEY"in ae&&"INNERTUBE_API_VERSION"in ae}
function ug(){return{innertubeApiKey:P("INNERTUBE_API_KEY",void 0),innertubeApiVersion:P("INNERTUBE_API_VERSION",void 0),Ca:P("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Da:P("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:P("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),Fa:P("INNERTUBE_CONTEXT_HL",void 0),Ea:P("INNERTUBE_CONTEXT_GL",void 0),Ga:P("INNERTUBE_HOST_OVERRIDE",void 0)||"",Ha:!!P("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)}}
function Wg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||P("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.mb||P("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().lb:b=Bc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=P("SESSION_INDEX",0),Q("pageid_as_header_web")&&(d["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return d}
function Xg(a){a=Object.assign({},a);delete a.Authorization;var b=Bc();if(b){var c=new Sc;c.update(P("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();c=3;Ca(b);void 0===c&&(c=0);if(!Tb){Tb={};for(var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),e=["+/=","+/","-_=","-_.","-_"],f=0;5>f;f++){var g=d.concat(e[f].split(""));Sb[f]=g;for(var h=0;h<g.length;h++){var k=g[h];void 0===Tb[k]&&(Tb[k]=h)}}}c=Sb[c];d=[];for(e=0;e<b.length;e+=3){var l=b[e],p=(f=e+1<b.length)?
...
;function Yg(a,b,c,d){Xb.set(""+a,b,{la:c,path:"/",domain:void 0===d?"youtube.com":d,secure:!1})}
;function Zg(){var a=new Rd;(a=a.isAvailable()?new Xd(a,"yt.innertube"):null)||(a=new Sd("yt.innertube"),a=a.isAvailable()?a:null);this.f=a?new Nd(a):null;this.g=document.domain||window.location.hostname}
Zg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,D()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(jd(b))}catch(f){return}else e=escape(b);Yg(a,e,c,this.g)};
Zg.prototype.get=function(a,b){var c=void 0,d=!this.f;if(!d)try{c=this.f.get(a)}catch(e){d=!0}if(d&&(c=Xb.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
Zg.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;Xb.remove(""+a,"/",void 0===b?"youtube.com":b)};var $g=new Zg;function ah(a,b,c,d){if(d)return null;d=$g.get("nextId",!0)||1;var e=$g.get("requests",!0)||{};e[d]={method:a,request:b,authState:Xg(c),requestTime:Math.round(T())};$g.set("nextId",d+1,86400,!0);$g.set("requests",e,86400,!0);return d}
function bh(a){var b=$g.get("requests",!0)||{};delete b[a];$g.set("requests",b,86400,!0)}
function ch(a){var b=$g.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(T())-d.requestTime)){var e=d.authState,f=Xg(Wg(!1));$a(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(T())),vg(a,d.method,e,{}));delete b[c]}}$g.set("requests",b,86400,!0)}}
;function Tg(a){var b=this;this.f=null;a?this.f=a:Q("delay_gel_until_config_ready")?Vg()&&(this.f=ug()):this.f=ug();zf(function(){ch(b)},0,5E3)}
Tg.prototype.isReady=function(){!this.f&&Vg()&&(this.f=ug());return!!this.f};
function vg(a,b,c,d){!P("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&ke(Error("Missing VISITOR_DATA when sending innertube request."));var e={headers:{"Content-Type":"application/json"},method:"POST",C:c,qa:"JSON",O:function(){d.O()},
...
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Ga;g&&(f=g);g=a.f.Ha||!1;var h=Wg(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=ne(""+f+("/youtubei/"+a.f.innertubeApiVersion+"/"+b),{alt:"json",key:a.f.innertubeApiKey}),l;if(d.retry&&Q("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=ah(b,c,h,g))){var p=e.onSuccess,n=e.na;e.onSuccess=function(v,q){bh(l);p(v,q)};
c.na=function(v,q){bh(l);n(v,q)}}try{Q("use_fetch_for_op_xhr")?Ee(k,e):(e.method="POST",e.C||(e.C={}),He(k,e))}catch(v){if("InvalidAccessError"==v)l&&(bh(l),l=0),ke(Error("An extension is blocking network request."));
else throw v;}l&&zf(function(){ch(a)},0,5E3)}
;var dh=D().toString();
function eh(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=D();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(dh)for(a=1,b=0;b<dh.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^dh.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var fh=z("ytLoggingTimeDocumentNonce_")||eh();x("ytLoggingTimeDocumentNonce_",fh,void 0);function gh(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function hh(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function ih(a){return P(hh(void 0===a?0:a),void 0)}
x("yt_logging_screen.getRootVeType",ih,void 0);function jh(){var a=ih(0),b;a?b=new zg({veType:a,youtubeData:void 0}):b=null;return b}
function kh(a){a=void 0===a?0:a;var b=P(gh(a));b||0!=a||(Q("kevlar_client_side_screens")||Q("c3_client_side_screens")?b="UNDEFINED_CSN":b=P("EVENT_ID"));return b?b:null}
x("yt_logging_screen.getCurrentCsn",kh,void 0);function lh(a,b,c){c=void 0===c?0:c;if(a!==P(gh(c))||b!==P(hh(c)))O(gh(c),a),O(hh(c),b),0==c&&(b=function(){setTimeout(function(){a&&yg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:fh,clientScreenNonce:a},Tg)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
x("yt_logging_screen.setCurrentScreen",lh,void 0);function mh(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=P("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=P("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=J(K(3,window.location.href));g&&f.push(g);g=J(K(3,d));if(0<=La(f,g)||!g&&0==d.lastIndexOf("/",0))if(Q("autoescape_tempdata_url")&&(f=document.createElement("a"),Kb(f,d),d=f.href),d){g=d.match(kc);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||
b.ved)&&(b=Object.assign({csn:kh()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Nb(d).toString(36),e=e?mc(e):"",Yg(b,e,k||5))}else k=b,e="ST-"+Nb(d).toString(36),k=k?mc(k):"",Yg(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var p=void 0===p?"":p;var n=void 0===n?window:n;c=n.location;a=nc(a,l)+p;a=a instanceof H?a:Ab(a);c.href=yb(a)}return!0}
;function nh(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||ab(b);this.assets=a.assets||{};this.attrs=a.attrs||ab(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
nh.prototype.clone=function(){var a=new nh,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Aa(c)?a[b]=ab(c):a[b]=c}return a};function oh(){L.call(this);this.f=[]}
t(oh,L);oh.prototype.m=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.nb)}L.prototype.m.call(this)};var ph=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function qh(a){a=a||"";if(window.spf){var b=a.match(ph);spf.style.load(a,b?b[1]:"",void 0)}else rh(a)}
function rh(a){var b=sh(a),c=document.getElementById(b),d=c&&bf(c,"loaded");d||c&&!d||(c=th(a,b,function(){bf(c,"loaded")||($e(c),lf(b),R(Ia(mf,b),0))}))}
...
function sh(a){var b=ec(document,"A");Kb(b,new H(wb,a));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Nb(a)}
;function uh(a,b,c,d){L.call(this);var e=this;this.l=this.X=a;this.U=b;this.w=!1;this.api={};this.V=this.G=null;this.H=new N;Uc(this,Ia(Vc,this.H));this.i={};this.R=this.W=this.h=this.ba=this.f=null;this.K=!1;this.j=this.B=null;this.Y={};this.ta=["onReady"];this.aa=null;this.ja=NaN;this.S={};this.o=d;vh(this);this.Z("WATCH_LATER_VIDEO_ADDED",this.Ja.bind(this));this.Z("WATCH_LATER_VIDEO_REMOVED",this.Ka.bind(this));this.Z("onAdAnnounce",this.va.bind(this));this.ua=new oh(this);Uc(this,Ia(Vc,this.ua));
this.T=0;c?this.T=R(function(){e.loadNewVideoConfig(c)},0):d&&(wh(this),xh(this))}
t(uh,L);m=uh.prototype;m.getId=function(){return this.U};
m.loadNewVideoConfig=function(a){if(!this.g){this.T&&(S(this.T),this.T=0);a instanceof nh||(a=new nh(a));this.ba=a;this.f=a.clone();wh(this);this.W||(this.W=yh(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.l.style.width=vc(Number(a)||a);if(a=this.f.attrs.height)this.l.style.height=vc(Number(a)||a);xh(this);this.w&&zh(this)}};
function wh(a){var b;a.o?b=a.o.rootElementId:b=a.f.attrs.id;a.h=b||a.h;"video-player"==a.h&&(a.h=a.U,a.f.attrs.id=a.U);a.l.id==a.h&&(a.h+="-player",a.f.attrs.id=a.h)}
...
function Ah(a){var b=!0,c=Bh(a);c&&a.f&&(a=Ch(a),b=bf(c,"version")===a);return b&&!!z("yt.player.Application.create")}
function xh(a){if(!a.g&&!a.K){var b=Ah(a);if(b&&"html5"==(Bh(a)?"html5":null))a.R="html5",a.w||Dh(a);else if(Eh(a),a.R="html5",b&&a.j)a.X.appendChild(a.j),Dh(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.B=function(){c=!0;var d=z("yt.player.Application.create"),e=a.f?a.f.clone():void 0;d(a.X,e,a.o);Dh(a)};
a.K=!0;b?a.B():(qf(Ch(a),a.B),qh(a.o?a.o.cssUrl:a.f.assets.css),Fh(a)&&!c&&x("yt.player.Application.create",null,void 0))}}}
function Bh(a){var b=ac(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
function Dh(a){if(!a.g){var b=Bh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.K=!1,b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||Gh(a)):a.ja=R(function(){Dh(a)},50)}}
function Gh(a){vh(a);a.w=!0;var b=Bh(a);b.addEventListener&&(a.G=Hh(a,b,"addEventListener"));b.removeEventListener&&(a.V=Hh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=Hh(a,b,e))}for(var f in a.i)a.G(f,a.i[f]);zh(a);a.W&&a.W(a.api);a.H.M("onReady",a.api)}
function Hh(a,b,c){var d=b[c];return function(){try{return a.aa=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.aa=e,ke(e))}}}
function vh(a){a.w=!1;if(a.V)for(var b in a.i)a.V(b,a.i[b]);for(var c in a.S)S(parseInt(c,10));a.S={};a.G=null;a.V=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.Z.bind(a);a.api.removeEventListener=a.Pa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.za.bind(a);a.api.getPlayerType=a.Aa.bind(a);a.api.getCurrentVideoConfig=a.ya.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Ia.bind(a)}
m.Ia=function(){return this.w};
m.Z=function(a,b){var c=this,d=yh(this,b);if(d){if(!(0<=La(this.ta,a)||this.i[a])){var e=Ih(this,a);this.G&&this.G(a,e)}this.H.subscribe(a,d);"onReady"==a&&this.w&&R(function(){d(c.api)},0)}};
m.Pa=function(a,b){if(!this.g){var c=yh(this,b);c&&Hd(this.H,a,c)}};
function yh(a,b){var c=b;if("string"==typeof b){if(a.Y[b])return a.Y[b];c=function(){var d=z(b);d&&d.apply(w,arguments)};
a.Y[b]=c}return c?c:null}
function Ih(a,b){var c="ytPlayer"+b+a.U;a.i[b]=c;w[c]=function(d){var e=R(function(){if(!a.g){a.H.M(b,d);var f=a.S,g=String(e);g in f&&delete f[g]}},0);
Za(a.S,String(e))};
return c}
...
m.Aa=function(){return this.R||(Bh(this)?"html5":null)};
m.za=function(){return this.aa};
function Eh(a){a.cancel();vh(a);a.R=null;a.f&&(a.f.loaded=!1);var b=Bh(a);b&&(Ah(a)||!Fh(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.X;b=a.firstChild;)a.removeChild(b)}
m.cancel=function(){this.B&&wf(Ch(this),this.B);S(this.ja);this.K=!1};
m.m=function(){Eh(this);if(this.j&&this.f&&this.j.destroy)try{this.j.destroy()}catch(b){je(b)}this.Y=null;for(var a in this.i)w[this.i[a]]=null;this.ba=this.f=this.api=null;delete this.X;delete this.l;L.prototype.m.call(this)};
function Fh(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
function Ch(a){return a.o?a.o.jsUrl:a.f.assets.js}
;var Jh={},Kh="player_uid_"+(1E9*Math.random()>>>0);function Lh(a){delete Jh[a.getId()]}
;var Mh=window,X=Mh.performance||Mh.mozPerformance||Mh.msPerformance||Mh.webkitPerformance||{};function Nh(a,b){Cg.call(this,1,arguments)}
t(Nh,Cg);function Oh(a,b){Cg.call(this,1,arguments)}
t(Oh,Cg);var Ph=new Dg("aft-recorded",Nh),Qh=new Dg("timing-sent",Oh);var Rh=!1;function Sh(){var a=Th(void 0);if(a.aft)return a.aft;for(var b=P("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function Uh(a){var b;(b=z("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Ka("ytcsi."+(a||"")+"data_",b));return b}
function Vh(){var a=Uh(void 0);a.info||(a.info={});return a.info}
function Th(a){a=Uh(a);a.tick||(a.tick={});return a.tick}
function Wh(){var a=Uh(void 0).nonce;a||(a=eh(),Uh(void 0).nonce=a);return a}
function Xh(){var a=Th(""),b=Sh();b&&!Rh&&(Ig(Ph,new Nh(Math.round(b-a._start),void 0)),Rh=!0)}
...
c=r(c);for(d=c.next();!d.done;d=c.next())$h(a,d.value);return a}
...
function bi(a,b){for(var c=r(b),d=c.next();!d.done;d=c.next())d=d.value,Zh(d)?a.push($h({},d)):ai(d)?a.push(bi([],d)):a.push(d);return a}
function Zh(a){return"object"===typeof a&&!Array.isArray(a)}
function ai(a){return"object"===typeof a&&Array.isArray(a)}
;function ci(){var a=z("ytcsi.debug");a||(a=[],x("ytcsi.debug",a,void 0),x("ytcsi.reference",{},void 0));return a}
function di(){var a=z("ytcsi.reference");a||(ci(),a=z("ytcsi.reference"));if(a[""])return a[""];var b={timerName:"",info:{},tick:{}};ci().push(b);return a[""]=b}
;function ei(a,b,c){c=void 0===c?{}:c;var d=Tg;P("ytLoggingEventsDefaultDisabled",!1)&&Tg==Tg&&(d=null);yg(a,b,d,c)}
;var fi=z("ytLoggingLatencyUsageStats_")||{};x("ytLoggingLatencyUsageStats_",fi,void 0);function gi(){this.f=0}
...
li={},mi=(li.mver="MEASUREMENT_VERSION_",li.pis="PLAYER_INITIALIZED_STATE_",li.yt_pt="LATENCY_PLAYER_",li.pa="LATENCY_ACTION_",li.yt_vst="VIDEO_STREAM_TYPE_",li),ni="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetBrowse_rid GetHistory_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function oi(){return!!P("FORCE_CSI_ON_GEL",!1)||Q("csi_on_gel")||!!Uh(void 0).useGel}
function pi(){var a=Uh(void 0);if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;C(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||ya,X);function qi(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function ri(a,b,c){"string"===typeof a&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return si(a)}
function si(a,b,c){if(B(a)){b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function ti(a,b,c,d){if(B(a)&&!Ba(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
;function ui(a){a=void 0===a?!1:a;L.call(this);this.f=new N(a);Uc(this,Ia(Vc,this.f))}
E(ui,L);ui.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
ui.prototype.j=function(a,b){this.g||this.f.M.apply(this.f,arguments)};function vi(a,b,c){ui.call(this);this.h=a;this.i=b;this.l=c}
t(vi,ui);function wi(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(jd(a),d.i))}}
vi.prototype.m=function(){this.i=this.h=null;ui.prototype.m.call(this)};function xi(a){L.call(this);this.f=a;this.f.subscribe("command",this.ra,this);this.h={};this.j=!1}
t(xi,L);m=xi.prototype;m.start=function(){this.j||this.g||(this.j=!0,wi(this.f,"RECEIVING"))};
m.ra=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&(a=d.event,a in this.h||(c=C(this.Ra,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":"string"===typeof d.event&&yi(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=zi(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=Ai(a,c))&&this.j&&!this.g&&wi(this.f,a,c))}}};
m.Ra=function(a,b){this.j&&!this.g&&wi(this.f,a,this.ea(a,b))};
m.ea=function(a,b){if(null!=b)return{value:b}};
function yi(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
m.m=function(){var a=this.f;a.g||Hd(a.f,"command",this.ra,this);this.f=null;for(var b in this.h)yi(this,b);L.prototype.m.call(this)};function Bi(a,b){xi.call(this,b);this.i=a;this.start()}
t(Bi,xi);Bi.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
Bi.prototype.removeEventListener=function(a,b){this.i.removeEventListener(a,b)};
function zi(a,b){switch(a){case "loadVideoById":return b=si(b),[b];case "cueVideoById":return b=si(b),[b];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return b=ti(b),[b];case "cuePlaylist":return b=ti(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
...
Bi.prototype.ea=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return xi.prototype.ea.call(this,a,b)};
Bi.prototype.m=function(){xi.prototype.m.call(this);delete this.i};function Ci(a,b,c){L.call(this);var d=this;c=c||P("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.w="*";this.i=c;this.sessionId=null;this.channel="widget";this.B=!!a;this.o=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.B&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
t(Ci,L);Ci.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.w)}catch(e){ke(e)}}};
Ci.prototype.m=function(){window.removeEventListener("message",this.o);L.prototype.m.call(this)};function Di(){var a=this.g=new Ci(!!P("WIDGET_ID_ENFORCE")),b=C(this.Oa,this);a.j=b;a.l=null;this.g.channel="widget";if(a=P("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
m=Di.prototype;m.Oa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,Ei(this,a)),this.j[a]=!0)):this.ma(a,b,c)};
m.ma=function(){};
function Ei(a,b){return C(function(c){this.sendMessage(b,c)},a)}
...
m.dispose=function(){this.g=null};function Gi(a){Di.call(this);this.f=a;this.h=[];this.addEventListener("onReady",C(this.La,this));this.addEventListener("onVideoProgress",C(this.Va,this));this.addEventListener("onVolumeChange",C(this.Wa,this));this.addEventListener("onApiChange",C(this.Qa,this));this.addEventListener("onPlaybackQualityChange",C(this.Sa,this));this.addEventListener("onPlaybackRateChange",C(this.Ta,this));this.addEventListener("onStateChange",C(this.Ua,this));this.addEventListener("onWebglSettingsChanged",C(this.Xa,
this))}
t(Gi,Di);m=Gi.prototype;m.ma=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&qi(a)){var d=b;if(B(d[0])&&!Ba(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=si.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=ri.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=ti.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);qi(a)&&Fi(this,this.fa())}};
...
m.Sa=function(a){Fi(this,{playbackQuality:a})};
m.Ta=function(a){Fi(this,{playbackRate:a})};
...
m.Wa=function(){Fi(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
m.Va=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:D()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());Fi(this,a)};
m.Xa=function(){var a={sphericalProperties:this.f.getSphericalProperties()};Fi(this,a)};
m.dispose=function(){Di.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function Hi(a,b,c){L.call(this);this.f=a;this.i=c;this.j=V(window,"message",C(this.l,this));this.h=new vi(this,a,b);Uc(this,Ia(Vc,this.h))}
t(Hi,L);Hi.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
Hi.prototype.m=function(){Xf(this.j);this.f=null;L.prototype.m.call(this)};function Ii(){var a=ab(Ji),b;return wd(new M(function(c,d){a.onSuccess=function(e){xe(e)?c(e):d(new Ki("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new Ki("Unknown request error","net.unknown",e))};
a.O=function(e){d(new Ki("Request timed out","net.timeout",e))};
b=He("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof xd&&b.abort();
return ud(c)})}
function Ki(a,b){F.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
t(Ki,F);function Li(){this.g=0;this.f=null}
Li.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),pd(a)?a:Mi(a)):2===this.g&&b?(a=b.call(c,this.f),pd(a)?a:Ni(a)):this};
Li.prototype.getValue=function(){return this.f};
Li.prototype.$goog_Thenable=!0;function Ni(a){var b=new Li;a=void 0===a?null:a;b.g=2;b.f=void 0===a?null:a;return b}
function Mi(a){var b=new Li;a=void 0===a?null:a;b.g=1;b.f=void 0===a?null:a;return b}
;function Oi(a){F.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Pi;this.isTimeout=a instanceof Ki&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof xd}
t(Oi,F);Oi.prototype.name="BiscottiError";function Pi(){F.call(this,"Biscotti ID is missing from server")}
t(Pi,F);Pi.prototype.name="BiscottiMissingError";var Ji={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Qi=null;function ee(){if("1"===Va(ce(),"args","privembed"))return ud(Error("Biscotti ID is not available in private embed mode"));Qi||(Qi=wd(Ii().then(Ri),function(a){return Si(2,a)}));
return Qi}
function Ri(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new Pi;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new Pi;a=a.id;fe(a);Qi=Mi(a);Ti(18E5,2);return a}
function Si(a,b){var c=new Oi(b);fe("");Qi=Ni(c);0<a&&Ti(12E4,a-1);throw c;}
function Ti(a,b){R(function(){wd(Ii().then(Ri,function(c){return Si(b,c)}),ya)},a)}
function Ui(){try{var a=z("yt.ads.biscotti.getId_");return a?a():ee()}catch(b){return ud(b)}}
;function Vi(a){if("1"!==Va(ce(),"args","privembed")){a&&de();try{Ui().then(function(){},function(){}),R(Vi,18E5)}catch(b){je(b)}}}
;var Z=z("ytglobal.prefsUserPrefsPrefs_")||{};x("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Wi(){this.f=P("ALT_PREF_COOKIE_NAME","PREF");var a=Xb.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
m=Wi.prototype;m.get=function(a,b){Xi(a);Yi(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
m.set=function(a,b){Xi(a);Yi(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
m.remove=function(a){Xi(a);Yi(a);delete Z[a]};
...
za(Wi);var $i=null,aj=null,bj=null,cj={};function dj(a){var b=a.id;a=a.ve_type;var c=Bg++;a=new zg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});cj[b]=a;b=kh();c=jh();b&&c&&Sg(b,c,[a])}
function ej(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(lh(b,a),a=jh()))for(var c in cj){var d=cj[c];d&&Sg(b,a,[d])}}
function fj(a){cj[a.id]=new zg({trackingParams:a.tracking_params})}
function gj(a){var b=kh(),c=cj[a.id];if(b&&c){a=Tg;c={csn:b,ve:Ag(c),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var d={ca:void 0,P:b};"UNDEFINED_CSN"==b?Ug("visualElementGestured",c,d):yg("visualElementGestured",c,a,d)}}
function hj(a){a=a.ids;var b=kh();if(b)for(var c=0;c<a.length;c++){var d=cj[a[c]];if(d){var e=Tg;d={csn:b,ve:Ag(d),eventType:1};var f={ca:void 0,P:b};"UNDEFINED_CSN"==b?Ug("visualElementShown",d,f):yg("visualElementShown",d,e,f)}}}
...
x("writeEmbed",function(){var a=P("PLAYER_CONFIG",void 0);Vi(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=P("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);P("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");b="player";var d=void 0===d?!0:d;b="string"===typeof b?ac(b):b;var e=Kh+"_"+Da(b),f=Jh[e];f&&d?a&&a.args&&a.args.fflags&&a.args.fflags.includes("web_player_remove_playerproxy=true")?f.api.loadVideoByPlayerVars(a.args||
null):f.loadNewVideoConfig(a):(f=new uh(b,e,a,void 0),Jh[e]=f,lf("player-added",f.api),Uc(f,Ia(Lh,f)));a=f.api;$i=a;a.addEventListener("onScreenChanged",ej);a.addEventListener("onLogClientVeCreated",dj);a.addEventListener("onLogServerVeCreated",fj);a.addEventListener("onLogVeClicked",gj);a.addEventListener("onLogVesShown",hj);d=P("POST_MESSAGE_ID","player");P("ENABLE_JS_API")?bj=new Gi(a):P("ENABLE_POST_API")&&"string"===typeof d&&"string"===typeof c&&(aj=new Hi(window.parent,d,c),bj=new Bi(a,aj.h));
...
var ij=ie(function(){var a=Th(void 0),b;(b=!Q("use_first_tick"))||(b=!("ol"in Th(void 0)));if(b&&(b="ol",X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b)),b=T(),a.ol=b,a=pi(),a.gelTicks&&(a.gelTicks.tick_ol=!0),T(),oi()?(di().tick.ol=void 0,a=Wh(),hi().tick("ol",a,void 0),Xh(),a=!0):a=!1,!a)){if(!z("yt.timing.pingSent_")&&(b=P("TIMING_ACTION",void 0),a=Th(void 0),z("ytglobal.timingready_")&&b&&a._start&&Sh())){Xh();b=!0;var c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in
a)){b=!1;break}if(b&&!oi()){d=Th(void 0);c=Vh();e=d._start;var f=P("CSI_SERVICE_NAME","youtube");b={v:2,s:f,action:P("TIMING_ACTION",void 0)};a=c.srt;void 0!==d.srt&&delete c.srt;if(c.h5jse){var g=window.location.protocol+z("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?c.h5jse=Math.round(c.h5jse-g.responseEnd):delete c.h5jse}d.aft=Sh();var h=Th(void 0);g=h.pbr;var k=h.vc;h=h.pbs;if(g&&k&&h&&g<k&&k<h&&Vh().yt_pvis&&"youtube"==f){Vh().yt_lt="hot_bg";if(oi()){f="hot_bg";
g=pi();g.gelInfos?g.gelInfos.info_yt_lt=!0:(k={},g.gelInfos=(k.info_yt_lt=!0,k));if("yt_lt"in ji){g=ji.yt_lt;0<=La(ki,g)&&(f=!!f);"yt_lt"in mi&&"string"===typeof f&&(f=mi.yt_lt+f.toUpperCase());g=g.split(".");h=k={};for(var l=0;l<g.length-1;l++){var p=g[l];h[p]={};h=h[p]}h[g[g.length-1]]=f;f=Yh({},k)}else 0<=La(ni,"yt_lt")||(f=new Te("Unknown label logged with GEL CSI"),f.params={label:"yt_lt"},ke(f)),f=void 0;f&&oi()&&(g=di(),Yh(g.info,f),g=pi(),"gelInfos"in g||(g.gelInfos={}),Yh(g.gelInfos,f),g=
Wh(),hi().info(f,g))}else di().info.yt_lt="hot_bg";f=d.vc;g=d.pbs;delete d.aft;c.aft=Math.round(g-f)}for(var n in c)"_"!=n.charAt(0)&&(b[n]=c[n]);d.ps=T();n={};f=[];for(var v in d)"_"!=v.charAt(0)&&(g=Math.round(d[v]-e),n[v]=g,f.push(v+"."+g));b.rt=f.join(",");(v=z("ytdebug.logTiming"))&&v(b,n);v=!!c.ap;Q("debug_csi_data")&&(c=z("yt.timing.csiData"),c||(c=[],Ka("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:b}));c="";for(var q in b)b.hasOwnProperty(q)&&(c+="&"+q+"="+b[q]);q=
"/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&v){var y=void 0===y?"":y;Se(q,y)||Pe(q,void 0,void 0,void 0,y)}else Pe(q);x("yt.timing.pingSent_",!0,void 0);Ig(Qh,new Oh(n.aft+(a||0),void 0))}}di().tick.ol=void 0}y=Wi.getInstance();v=!!((Zi("f"+(Math.floor(119/31)+1))||0)&67108864);q=1<window.devicePixelRatio;document.body&&Zc(document.body,"exp-invert-logo")&&(q&&!Zc(document.body,"inverted-hdpi")?(n=document.body,n.classList?n.classList.add("inverted-hdpi"):Zc(n,"inverted-hdpi")||
(a=Xc(n),Yc(n,a+(0<a.length?" inverted-hdpi":"inverted-hdpi")))):!q&&Zc(document.body,"inverted-hdpi")&&$c());v!=q&&(v="f"+(Math.floor(119/31)+1),n=Zi(v)||0,n=q?n|67108864:n&-67108865,0==n?delete Z[v]:(q=n.toString(16),Z[v]=q.toString()),y.save())}),jj=ie(function(){var a=$i;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&If.dispose();a=0;for(var b=Bf.length;a<b;a++){var c=Bf[a];if(!isNaN(c)){var d=z("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}Bf.length=0;vf("//static.doubleclick.net/instream/ad_status.js");Cf=!1;O("DCLKSTAT",0);Wc(bj,aj);if(a=$i)a.removeEventListener("onScreenChanged",ej),a.removeEventListener("onLogClientVeCreated",dj),a.removeEventListener("onLogServerVeCreated",fj),a.removeEventListener("onLogVeClicked",gj),a.removeEventListener("onLogVesShown",
hj),a.destroy();cj={}});
window.addEventListener?(window.addEventListener("load",ij),window.addEventListener("unload",jj)):window.attachEvent&&(window.attachEvent("onload",ij),window.attachEvent("onunload",jj));Ka("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||Of);Ka("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||Pf);Ka("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||Ef);
Ka("yt.player.exports.navigate",z("yt.player.exports.navigate")||mh);Ka("yt.util.activity.init",z("yt.util.activity.init")||ag);Ka("yt.util.activity.getTimeSinceActive",z("yt.util.activity.getTimeSinceActive")||dg);Ka("yt.util.activity.setTimestamp",z("yt.util.activity.setTimestamp")||bg);}).call(this);
